...
/*
 * Инсталируем только модуль modLivestreet
 */
...
define('PKG_CATEGORY', 'directResize');
...
// $modx->lexicon->load('yley:properties');
...
$namespace->set('path','{core_path}components/'.PKG_PATH.'/');
